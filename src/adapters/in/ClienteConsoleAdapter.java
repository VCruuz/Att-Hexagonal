...
// adapter de entrada: é quem conversa com o usuário pelo console
// ele lê o que o usuário digita e chama o port de entrada certo
// não tem lógica de negócio aqui, só captura os dados e repassa
//
// se fosse uma API REST, seria outro adapter fazendo a mesma coisa
// mas o serviço e o domínio continuariam iguais
public class ClienteConsoleAdapter {

    // dependências declaradas como interfaces (ports de entrada)
    // o adapter não sabe que por baixo é o ClienteService
    ...
    // recebe cada caso de uso separado para manter o desacoplamento
    ...
    // inicia o sistema e fica no loop até o usuário digitar 0
    public void iniciar() {
        int opcao = -1;
    ...
    // lê a opção digitada, se não for número retorna -1 para não quebrar o switch
    ...
    private void cadastrarCliente() {
        ...
        // chama o port de entrada de cadastro
    ...
    private void buscarCliente() {
        ...
        try {
            ...
            // chama o port de busca, que retorna um Optional
            Optional<Cliente> resultado = buscarUseCase.buscarPorId(id);

            // isPresent() verifica se achou alguma coisa
